...
SECRET_KEY = 'p)h-%mjb!-bw0*!xyi-snhvv6k!=mt*@cgk-h(572rf6(31aph'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'unisport', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
COVERAGE_REPORT_HTML_OUTPUT_DIR = os.path.join(BASE_DIR, '..', 'test_coverage_report')